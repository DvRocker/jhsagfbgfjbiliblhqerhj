...
.then(co => {
  md = co.first().content
        co.first().delete()
        m.delete();
message.channel.send('**واخيرا وليس اخرا,قبل تقديم لدينا شرط الشرط هو انك تضع شعار سيرفرنا ||:! ᶠᴬᴹᴼᵁᔆ: اذا وافقت على الشرط اكتب حسنا واذا لم توافق على الشرط اكتب لا**').then(ms => {
...
client.on('message', message => {
  ...
  /*let b5bzlog = client.channels.find("name", "kick-ban");
